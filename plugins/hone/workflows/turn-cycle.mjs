export const meta = {
  name: 'hone-turn-cycle',
  description: 'One hone turn: parallel worktree build of picked gaps, integrate + automated checks, adversarial review panel with verification',
  phases: [
...
const cycleBranch = (args && args.cycleBranch) || 'hone/cycle'
...
log(`turn-cycle: ${items.length} item(s) onto ${cycleBranch} from ${base}`)
